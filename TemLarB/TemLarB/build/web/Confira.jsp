            ...
            <div class="row">
                ...
                <div class="small-12 medium-12 large-12 columns " > 
                    <ul class="breadcrumbs">
                        <li><a href="index.jsp">Página Inicial</a></li>
                        <li><a href="imoveisVenda.jsp">Imóveis a alugar</a></li>
                        <li class="unavailable"><a href="casaA55.jsp">Casas</a></li>
            ...
            <div class="row">
                <fieldset>
                    <div class="small-12 medium-6 large-6  columns " > 
                        ...
                        <h5><font color = "#4682B4"><b>CASA &nbsp;A&nbsp; ALUGAR </b></font></h5>      
                        <h5><strong> Avenida Silvio Rálio</strong></h5>
                        <h5>Centro, Santa Albertina, SP</h5>


                    </div>
                    <div class="small-12 medium-6 large-6  columns " > 

                        <p class="text-right"><font color = "#4682B4">VALOR DO ALUGUEL </font></p>
                        <h4 class="text-right"><strong>  R$ 550,00</strong></h4>
            ...
            <div class="row">
                <fieldset>
                    <div class="small-6 medium-2 large-2  columns " > 
                        ...
                        <h5><font color = "#A9A9A9"> Quartos </font></h5>
                    </div>
                    <div class="small-6 medium-2 large-2   columns " > 
                        <h5><strong> &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;2</strong></h5>
                        <h5><font color = "#A9A9A9"> Banheiros</font></h5>
                    </div>
                    <div class="small-6 medium-2 large-2   columns " > 
                        <h5><strong> &nbsp;&nbsp;&nbsp;1</strong></h5>
                        <h5><font color = "#A9A9A9"> Suite</font></h5>
                    </div>
                    <div class="small-6 medium-2 large-2   columns " > 
                        <h5><strong> &nbsp;&nbsp;&nbsp;1</strong></h5>
                        <h5><font color = "#A9A9A9"> Cozinha</font></h5>
                    </div>
                    <div class="small-6 medium-2 large-2   columns " > 
                        <h5><strong> &nbsp;&nbsp;&nbsp;1</strong></h5>
                        <h5><font color = "#A9A9A9"> Despensa</font></h5>
                    </div>
                    <div class="small-6 medium-2 large-2   columns " > 
                        <h5><strong>600,00</strong></h5>
                        <h5><font color = "#A9A9A9">&nbsp;&nbsp;&nbsp;&nbsp; M²</font></h5>
                    </div>
                ...
                <fieldset>	
                    <div class="small-12 medium-12 large-12  columns " >
                        ...
                        <ul class="clearing-thumbs" data-clearing>
                            <li><a class="th" href="img/casaaluga1.jpg"  >
                                    <img src="img/casaaluga1-thumb.jpg"  height="250px" width="250px" data-caption="" alt="Casa venda"> 
                                </a>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</li>

                            <li><a class="th" href="img/casaaluga2.jpg"  >
                                    <img src="img/casaaluga2-thumb.jpg"  height="250px" width="250px"  data-caption="" alt="Casa venda"> 
                                </a>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</li>

                            <li><a class="th" href="img/casaaluga3.jpg"  >
                                    <img src="img/casaaluga3-thumb.jpg"  height="250px" width="250px"  data-caption="" alt="Casa venda"> 
                                </a> </li>

                            <li><a class="th" href="img/casaaluga4.jpg"  >
                                    <img src="img/casaaluga4-thumb.jpg"  height="250px" width="250px" data-caption="" alt="Casa venda"> 
                                </a></li>
                        </ul>
                ...
                <fieldset>	
                    <div class="small-12 medium-12 large-12  columns " >
                        ...
                        <p  class="text-justify">
                            Casa ampla próximo a  Prefeitura Municipal com 2 dormitórios, 1 cozinhas, 2 banheiros, copa, sala ampla,  com despensa
                            1 vagas de garagem coberta e 1 sem cobertura,  toda em piso frio em excelente estado, pinturas novas, murada, portão eletrônico.
