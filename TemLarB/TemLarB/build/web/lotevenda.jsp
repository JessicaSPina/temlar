        ...
        <div class="small-12 medium-12 large-12 columns " > 
            ...
            <ul class="breadcrumbs">
                <li><a href="index.jsp">Página Inicial</a></li>
                        ...
                        <li class="unavailable"><a href="lotevenda.jsp">Lotes</a></li>
...
<div class="expanded row" style=" max-width: 95% ">
           <div class="row" >
    <h4 class="text-center" style=" color:orange;" >Lotes para Venda</h4>
...
<div class="small-12 medium-3 large-3 columns " > 
  ...
  <!--c:forEach var="lote" items="${lotes}">-->
                    <ul class="pricing-table">
                        ...
                        <li class="cta-button"><a class="button" href="detalheslotevenda.jsp">Confira</a></li>
                    </ul>
