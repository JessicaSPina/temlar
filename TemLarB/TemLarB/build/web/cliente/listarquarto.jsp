                                ...
                                <table id="example" class="display" style="width:100%">
                                    ...
                                    <tbody>
                                        <c:forEach var="quarto" items="${quartos}">
                                            <tr>
                                                <td>${quarto.tipoTelhadoQuarto}</td>
                                                <td>${quarto.tipoPisoQuarto}</td>
                                                <td>${quarto.situacaoPinturaQuarto}</td>
                                                <td>${quarto.moveisquarto}</td>
                                                <td>${quarto.cepquarto}</td>
                                                 <td>${quarto.endquarto}</td>
                                                  <td>${quarto.ufquarto}</td>
                                                  <td>${quarto.numeroquarto}</td>
                                                   <td>${quarto.cidadequarto}</td>
                                                    <td>${quarto.bairroquarto}</td>
                                                     <td>${quarto.valorquarto}</td>
                                                     
                                                <td><a href="ExcluirQuarto?idquarto=${quarto.idQuarto}">Excluir</a></td>
                                                <td><a href="CarregarQuartoi?idquarto=${quarto.idQuarto}">Alterar</a></td>
