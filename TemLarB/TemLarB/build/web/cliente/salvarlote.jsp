        ...
        <div class="off-canvas-wrap" data-offcanvas>
            ...
            <div class="inner-wrap">
                ...
                <div class="wrap-fluid" id="paper-bg">
                    ...
                    <h2> ${sucesso}</h2>
                    <form data-abide name="salvar" action="<%=request.getContextPath()%>/SalvarLote" method="POST">
                        <h5> Cadastro Lote</h5> 

                        <div class="id-field">

                            <input type="hidden" name="idpessoa" value="<%=request.getSession().getAttribute("idpessoa")%>" readonly="readonly" /></br></br>
                            <input type="hidden" name="idlote" value="${lote.idLote}" readonly="readonly" /> </br></br>
                        ...
                        <div class="row">
                            <div class="large-9  columns">
                                ...
                                <div class="small-12 medium-4 large-4 columns" >
                                    ...
                                    <div class="tipoMuro-field">
                                        <label>Tipo Muro <small>required</small>

                                            <select name="tipomuro"> 


                                                <option name="alvenaria" value="alvenaria" id="alvenaria">Alvenaria</option>
                                                <option name="pedra" value="pedra" id="pedra">Pedra</option>
                                                <option name="placa" value="placa" id="placa">Placa</option>

                                                <option name="outros" value="outros" id="outros">Outros</option>
                                ...
                                <div class="small-12 medium-4 large-4 columns" >
                                    ...
                                    <div class="aterradocomercial-field">
                                        <label>Aterrado<small>required</small>
                                            <select name="aterrado"> 


                                                <option name="sim" value="sim"  value="${lote.aterrado}" id="sim">Sim</option>
                                                <option name="nao" value="nao"  value="${lote.aterrado}" id="nao">Não</option>
                                ...
                                <div class="small-12 medium-4 large-4 columns" >
                                    <div class="tipoanuncio-field">
                                        <label>Tipo Anúncio? <small>required</small>
                                            ...
                                            <input type="radio" name="tipoanuncio" value="Locação" id="locacao" ${imovel.tipoAnuncio == 'Locação' ? 'checked' : ''} >
                                            <label for="locacao">Locação</label>
                                            <input type="radio" name="tipoanuncio" value="Venda" id="venda" ${imovel.tipoAnuncio == 'Venda' ? 'checked' : ''}>
                            ...
                            <div class="large-9  columns">
                                ...
                                <div class="small-12 medium-4 large-4 columns" >
                                    <div class="descricaoimovel-field">
                                        ...
                                        <small class="error">Digite a descrição</small>
                                    </div>
