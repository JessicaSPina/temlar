                        ...
                        <div class="box">
                            ...
                            <div class="box-body " style="display: block;">
                                ...
                                <table id="example" class="display" style="width:70%">
                                    ...
                                    <tbody>
                                        <c:forEach var="comercial" items="${comerciais}">
                                            <tr>
                                                
                                                  
                                                  <td>${comercial.numBanheirosComercial}</td>
                                                  <td>${comercial.numSalasComercial}</td>
                                                   <td>${comercial.copaComercial}</td>
                                                    <td>${comercial.QntVagaGaragemComercial}</td>
                                                     <td>${comercial.tipoTelhadoComercial}</td>
                                                      
                                                       <td>${comercial.situacaoPinturaComercial}</td>
                                                        <td>${comercial.tipoPisoComercial}</td>
                                                         
                                                          <td>${imovel.valorImovel}</td>
                                                           <td>${comercial.mobiliaComercial}</td>
                                                            <td>${imovel.cepImovel}</td>
                                                             <td>${imovel.ruaImovel}</td>
                                                             <td>${imovel.cidadeImovel}</td>
                                                           <td>${imovel.ufImovel}</td>
                                                            <td>${imovel.numeroImovel}</td>
                                                             <td>${imovel.bairroImovel}</td>
                                                             
                                                              <td>${imovel.areaImovel}</td>
                                                              <td>${imovel.tipoAnuncioImovel}</td>
                                                              <td>${imovel.descricaoImovel}</td>
                                                              <td>${imovel.metragemImovel}</td>
                                                     
                                                <td><a href="ExcluirComercial?idComercial=${comercial.idComercial}">Excluir</a></td>
                                                <td><a href="CarregarComercial?idComercial=${comercial.idComercial}">Alterar</a></td>
