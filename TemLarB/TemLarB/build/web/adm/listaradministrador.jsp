                                ...
                                <table id="example" class="display" style="width:100%">
                                    ...
                                    <tbody>
                                        <c:forEach var="administrador" items="${administradores}">
                                            <tr>
                                                <td>${administrador.nomeAdm}</td>
                                                <td>${administrador.cpfAdm}</td>
                                                <td>${administrador.emailAdm}</td>
                                                <td>${administrador.loginAdm}</td>
                                                <td>${administrador.senhaAdm}</td>
                                                <td><a href="ExcluirAdministrador?idadministrador=${administrador.idAdm}">Excluir</a></td>
                                                <td><a href="CarregarAdministrador?idadministrador=${administrador.idAdm}">Alterar</a></td>
