                                ...
                                <li>
                                    ...
                                    <ul>
                                        ...
                                        <li>
                                            ...
                                            <a href="${pageContext.request.contextPath}/adm/listartipoimovel.jsp" title="ListarTipoImovel">Listar</a>
                                        </li>
                                    </ul>
                                </li>
                                  <li>
            ...
            <div class="wrap-fluid" id="paper-bg">
                ...
                <div class="row">
                                    ...
                                    <div class="large-9 columns">
                                         <h2> ${sucesso}</h2>
                                         <form data-abide name="salvar" action="<%=request.getContextPath()%>/SalvarTipoImovel" method="POST">
                                           <h5> Cadastro Tipo de Imóvel</h5>
                                            <div class="id-field">
                                              
                                            <input type="hidden" name="idtipo" value="${tipoimovel.idTipo}" readonly="readonly" /></br></br>
                                            ...
                                            <div class="name-field">
                                                <label>Nome <small>required</small>
                                                    <input type="text" name="nometipo" value="${tipoimovel.nomeTipo}" required pattern="[a-zA-Z]+">
                                                </label>
                                                <small class="error">Nome Tipo Imóvel Inválido</small>
                                            </div>
