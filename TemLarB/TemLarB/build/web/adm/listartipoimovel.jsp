                        ...
                        <div class="box">
                            ...
                            <div class="box-body " style="display: block;">
                                ...
                                <table id="example" class="display" style="width:100%">
                                    ...
                                    <tbody>
                                        <c:forEach var="tipoimovel" items="${tiposimoveis}">
                                            <tr>
                                                <td>${tipoimovel.nomeTipo}</td>
                                               
                                                <td><a href="ExcluirTipoImovel?idtipo=${tipoimovel.idTipo}">Excluir</a></td>
                                                <td><a href="CarregarTipoImovel?idtipo=${tipoimovel.idTipo}">Alterar</a></td>
