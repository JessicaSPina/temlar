    ...
    <div class="off-canvas-wrap" data-offcanvas>
        ...
        <div class="row">
                                    ...
                                    <div class="large-9 columns">
                                        ...
                                        <h2> ${sucesso}</h2>
                                        <form data-abide name="salvar" action="<%=request.getContextPath()%>/SalvarPessoaJuridica" method="POST">
                                            ...
                                            <div class="name-field">
                                                ...
                                                <label>Razão Social <small>required</small>
                                                    <input type="text" name="nomeJuridica" value="${pessoajuridica.nomeJuridica}" required pattern="[a-zA-Z]+"/>
                                                </label>
                                                <small class="error">Digite a Razão Social</small>
                                            </div>
                                                ...
                                                <label>CNPJ<small>required</small>
                                                    <input type="text" name="cnpjjuridica" value="${pessoajuridica.cnpjjuridica}" required pattern="[0-9]{2}\.?[0-9]{3}\.?[0-9]{3}\/?[0-9]{4}\-?[0-9]{2}" placeholder="00.000.000/0000-00"/>
                                                </label>
                                                <small class="error">Digite o CNPJ</small>
                                            </div>
                                           <div class="ie-field">
                                                <label>IE - Inscrição Estadual<small>required</small>
                                                    <input type="text" name="iejuridica" value="${pessoajuridica.iejuridica}" required pattern="" placeholder="" />
                                                </label>
                                                <small class="error">Digite a IE</small>
                                            </div>
                                            
                                             <div class="im-field">
                                                <label>IM - Inscrição Municipal<small>required</small>
                                                    <input type="text" name="imjuridica" value="${pessoajuridica.imjuridica}" required pattern="" placeholder="" />
                                                </label>
                                                <small class="error">Digite a IM</small>
                                            </div>
