                   ...
                   <div class="large-12 columns">
                        <div class="box">
                            <div class="box-header bg-transparent">
                                ...
                                <h3> Lista de Pessoas Físicas</h3>
                        ...
                        <table id="example" class="display" style="width:100%">
                                    ...
                                    <tbody>
                                        <c:forEach var="pessoafisica" items="${pessoafisicas}">
                                            <tr>
                                                <td>${pessoafisica.nomeFisica}</td>
                                                <td>${pessoafisica.sexoFisica}</td>
                                               <td>${pessoafisica.rgFisica}</td>
                                               <td>${pessoafisica.cpfFisica}</td>
                                               <td>${pessoafisica.dataNascimentoFisica}</td>
                                               <td>${pessoafisica.estadoCivilFisica}</td>
                                                <td><a href="ExcluirPessoaFisica?idfisica=${pessoafisica.idFisica}">Excluir</a></td>
                                                <td><a href="CarregarPessoaFisica?idfisica=${pessoafisica.idFisica}">Alterar</a></td>
