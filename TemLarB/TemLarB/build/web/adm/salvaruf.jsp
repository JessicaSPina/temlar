                ...
                <ul class="breadcrumbs">
                  ...
                  <div class="row">
                                    ...
                                    <div class="large-9 columns">
                                        <h5> Cadastro de UF</h5>
                                        </br>
                                        <form data-abide name="salvar" action="<%=request.getContextPath()%>/SalvarUf" method="POST">
                                            
                                            
                                            <div class="id-field">
                                              
                                                    <input type="hidden" name="iduf" required >
                                                </label>
                                               
                                            </div>
                                            
                                           <div class="sigla-field">
                                                <label>Sigla UF<small>required</small>
                                                    <input type="text" name="sigla"  required pattern="[a-zA-Z]+">
                                                </label>
                                                <small class="error">Digite a Sigla</small>
                                            </div>
