        ...
        <div class="small-12 medium-12 large-12 columns " > 
            ...
            <ul class="breadcrumbs">
                ...
                <li class="unavailable"><a href="#">Imóveis a Alugar</a></li>
                        <li><a href="apartamentoalugar.jsp"> Apartamentos a Alugar</a></li>
                        <li class="unavailable"><a href="detalhesapartamentoalugar.jsp">Detalhes Apartamento</a></li>
...
<div class="small-12 medium-6 large-6 columns" > 
    ...
    <h2 style="color:#FFA500 " class="text-center"><b>ALUGA - SE</b></h2>  
     <h3 style="color:#FFA500 " class="text-center"><b>APARTAMENTO</b></h3>  
