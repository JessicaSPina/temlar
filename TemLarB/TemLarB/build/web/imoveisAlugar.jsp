...
<body>        
    ...
    <div class="row">
        ...
        <div class="small-12 medium-12 large-12  columns " > 
            ...
            <div class="row">
                <div class="small-12 medium-12 large-12 columns " > 
                    <ul class="breadcrumbs">
                        <li><a href="index.jsp">Página Inicial</a></li>
                        <li class="current"><a href="imoveisVenda.jsp">Imóveis a Alugar</a></li>
            ...
            <div class="row">
                <h4 class="text-center" > Imóveis para Alugar</h4>
                </br>
                <div class="small-12 medium-12 large-12 columns " > 
                </div>
            </div>
            <div class="row">
                ...
                <div class="small-12 medium-3 large-3 columns " > 
                    <ul class="pricing-table">
                        ...
                        <img src="img/sitio8.jpg"  />
                        <li class="price">R$400,00</li>
                        <li class="description"><b>CASA</b></li>
                        <li class="bullet-item">2 Quartos</li>

                        <li class="bullet-item">1 Banheiro</li>
                        <li class="cta-button"><a class="button" href="ranchoA40.jsp">Confira</a></li>
                    </ul>
                ...
                <div class="small-12 medium-3 large-3 columns " > 
                    <ul class="pricing-table">
                        <li class="title">Aluga-se</li>
                        <img src="img/casaaluga1.jpg"   />
                        <li class="price">550,00</li>
                        <li class="description"><b>CASA</b></li>
                        <li class="bullet-item">2 Quartos</li>

                        <li class="bullet-item">2 Banheiros</li>
                        <li class="cta-button"><a class="button" href="casaA55.jsp">Confira</a></li>
                    </ul>
                ...
                <div class="small-12 medium-3 large-3 columns " > 
                    <ul class="pricing-table">
                        <li class="title">Aluga-se</li>
                        <img src="img/aluga5.jpg"   />
                        <li class="price">R$450,00</li>
                        <li class="description"><b>CASA</b></li>
                        <li class="bullet-item">2 Quartos</li>

                        <li class="bullet-item">1 Banheiro</li>
                        <li class="cta-button"><a class="button" href="casaA45.jsp">Confira</a></li>
                    </ul>
                ...
                <div class="small-12 medium-3 large-3 columns " > 
                    <ul class="pricing-table">
                        <li class="title">Aluga-se</li>
                        <img src="img/ranchoA1.jpg"   />
                        <li class="price">550,00</li>
                        <li class="description"><b>CASA</b></li>
                        <li class="bullet-item">2 Quartos</li>

                        <li class="bullet-item">2 Banheiros</li>
                        <li class="cta-button"><a class="button" href="RanchoA55.jsp">Confira</a></li>
                    </ul>
                ...
                <div class="small-12 medium-3 large-3 columns " > 
                    <ul class="pricing-table">
                        <li class="title">Aluga-se</li>
                        <img src="img/rancho6.jpg"   />
                        <li class="price">R$350,00</li>
                        <li class="description"><b>CASA</b></li>
                        <li class="bullet-item">2 Quartos</li>

                        <li class="bullet-item">1 Banheiro </li>
                        <li class="cta-button"><a class="button" href="ranchoA35.jsp">Confira</a></li>
                    </ul>
