...
<div class="expanded row" style=" max-width: 95% ">
        ...
        <div class="small-12 medium-12 large-12 columns " > 
            ...
            <ul class="breadcrumbs">
                ...
                <li class="unavailable"><a href="#">Imóveis Venda</a></li>
                        <li><a href="comercialvenda.jsp"> Comercial a Venda</a></li>
                        <li class="unavailable"><a href="detalhescomercialvenda.jsp">Detalhes Comercial Venda</a></li>
