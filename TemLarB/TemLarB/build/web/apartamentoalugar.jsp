        ...
        <div class="small-12 medium-12 large-12 columns " > 
            ...
            <ul class="breadcrumbs">
                <li><a href="index.jsp">Página Inicial</a></li>
                        ...
                        <li class="unavailable"><a href="apartamentoAlugar.jsp">Apartamentos</a></li>
...
<div class="expanded row" style=" max-width: 95% ">
           <div class="row" >
    <h4 class="text-center" style=" color:orange;" > Apartamentos para Alugar</h4>
...
<div class="small-12 medium-3 large-3 columns " > 
  ...
  <!--c:forEach var="casa" items="${casas}">-->
                    <ul class="pricing-table">
                        <li class="title"  ${casa.tipoAnuncio}> ALUGA-SE</li>
                        <img src="#"   />
                        ...
                        <li class="cta-button"><a class="button" href="detalhesapartamentoalugar.jsp">Confira</a></li>
                    </ul>
