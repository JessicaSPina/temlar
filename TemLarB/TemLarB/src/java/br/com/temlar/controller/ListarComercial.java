 ...
 */
@WebServlet(name = "ListarComercial", urlPatterns = {"/ListarComercial"})
public class ListarComercial extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
       ...
       try {
            ...
            request.setAttribute("comerciais", dao.listar());
            request.getRequestDispatcher("cliente/listarcomercial.jsp").forward(request, response);
        } catch (Exception ex) {
