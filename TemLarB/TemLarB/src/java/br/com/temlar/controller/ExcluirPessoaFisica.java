 ...
 * @author Ana Paula
 */
@WebServlet(name = "ExcluirPessoaFisica", urlPatterns = {"/ExcluirPessoaFisica"})
public class ExcluirPessoaFisica extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try{
            ...
            request.getRequestDispatcher("ListarPessoaFisica").forward(request, response);
        }catch (Exception ex){
