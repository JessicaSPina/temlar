 ...
 */
@WebServlet(name = "ExcluirComercial", urlPatterns = {"/ExcluirComercial"})
public class ExcluirComercial extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try{
            ...
            dao.excluir(idImovel);
            request.getRequestDispatcher("ListarComercial").forward(request, response);
        }catch (Exception ex){
