 ...
 */
@WebServlet(name = "ListarPlano", urlPatterns = {"/ListarPlano"})
public class ListarPlano extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
       ...
       try {
            ...
            request.setAttribute("planos", dao.listar());
            request.getRequestDispatcher("adm/listarplano.jsp").forward(request, response);
        }catch(Exception ex){
