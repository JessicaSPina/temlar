 ...
 */
@WebServlet(name = "CarregarPlano", urlPatterns = {"/CarregarPlano"})
public class CarregarPlano extends HttpServlet {
     ...
     */
       ...
       protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try{
            ...
            request.setAttribute("plano", dao.carregar(idPlano));
            request.getRequestDispatcher("adm/salvarplano.jsp").forward(request,response);
            
        }catch (Exception ex){
            System.out.println("Problemas ao carregar Plano! Erro: " + ex.getMessage());
            ex.printStackTrace();
        }
    }
