 ...
 * @author Ana Paula
 */
@WebServlet(name = "ListarQuarto", urlPatterns = {"/ListarQuarto"})
public class ListarQuarto extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
       ...
       try {
            ...
            request.setAttribute("quartos", dao.listar());
            request.getRequestDispatcher("listarquarto.jsp").forward(request, response);
        }catch(Exception ex){
