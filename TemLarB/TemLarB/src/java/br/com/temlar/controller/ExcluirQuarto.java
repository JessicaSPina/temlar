 ...
 * @author Ana Paula
 */
@WebServlet(name = "ExcluirQuarto", urlPatterns = {"/ExcluirQuarto"})
public class ExcluirQuarto extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try{
            ...
            request.getRequestDispatcher("ListarQuarto").forward(request, response);
        }catch (Exception ex){
