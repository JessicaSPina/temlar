 ...
 */
@WebServlet(name = "ExcluirPlano", urlPatterns = {"/ExcluirPlano"})
public class ExcluirPlano extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try{
            ...
            dao.excluir(idPlano);
            request.getRequestDispatcher("ListarPlano").forward(request, response);
        }catch (Exception ex){
