 ...
 */
@WebServlet(name = "CarregarComercial", urlPatterns = {"/CarregarComercial"})
public class CarregarComercial extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
       ...
       int idImovel = Integer.parseInt(request.getParameter("idimovel"));
        try{
            ...
            request.setAttribute("comercial", dao.carregar(idImovel));
