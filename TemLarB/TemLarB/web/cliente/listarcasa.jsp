        ...
        <div class="inner-wrap">
            ...
            <div class="wrap-fluid" id="paper-bg">
                ...
                <ul class="breadcrumbs">
                    ...
                    <li>Casa
                    <li> Listar Casa (Ruaral\ Urbana\ Apartamento)
                    </li>
              ...
              <div class="large-12 columns">
                        <div class="box">
                            <div class="box-header bg-transparent">
                                ...
                                <h3> Lista de Casa (Rural\ Urbana\ Apartamento)</h3>
                                    ...
                                    <tbody>
                                        <c:forEach var="casa" items="${casas}">
                                            <tr>
                                                  ...
                                                  <td>${casa.tipoCasa}</td>
                                                  <td>${casa.numQuarto}</td>
                                                  <td>${casa.numBanheiro}</td>
                                                  <td>${casa.numSalas}</td>
                                                   <td>${casa.numCozinhas}</td>
                                                    <td>${casa.QntVagaGaragem}</td>
                                                     <td>${casa.tipoQuintal}</td>
                                                     
                                                      <td>${casa.tipoTelhado}</td>
                                                       <td>${casa.situacaoPintura}</td>
                                                        <td>${casa.despejo}</td>
                                                         <td>${casa.areaLazer}</td>
                                                          <td>${casa.areaServico}</td>
                                                        <td>${casa.tipoPiso}</td>
                                                ...
                                                <td><a href="ExcluirCasa?idcasa=${casa.idCasa}">Excluir</a></td>
                                                <td><a href="CarregarCasa?idcasa=${casa.idCasa}">Alterar</a></td>
