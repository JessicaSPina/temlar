        ...
        <div class="inner-wrap">
            ...
            <div class="wrap-fluid" id="paper-bg">
                ...
                <div class="top-bar-nest">
                    ...
                    <h2> ${sucesso}</h2>
                    <form data-abide name="salvar" action="<%=request.getContextPath()%>/SalvarComercial" method="POST">
                        <h5> Cadastro Comercial</h5> 

                        <div class="id-field">
                             <input type="hidden" name="idpessoa" value="<%=request.getSession().getAttribute("idpessoa")%>" readonly="readonly" /></br></br>

                            <input type="hidden" name="idcomercial" value="${comercial.idComercial}" readonly="readonly" /> </br></br>
                        ...
                        <div class="row">
                            <div class="large-9  columns">
                                ...
                                <div class="small-12 medium-4 large-4 columns" >
                                    ...
                                    <div class="numbanheiroscomercial-field">
                                ...
                                <div class="small-12 medium-4 large-4 columns" >
                                    ...
                                    <div class="tipoTelhadoComercial-field">
                        ...
                        <div class="row">
                            <div class="large-9  columns">
                                ...
                                <div class="small-12 medium-4 large-4 columns" >
                                    <div class="CopaComercial-field">
                                        <label>Tem Copa ? <small>required</small>
                                            </br>
                                            <input type="radio" name="copa" value="sim"   id="sim"  ${comercial.CopaSim == 'sim' ? 'checked' : ''} >
                                            <label for="sim">Sim</label>
                                            <input type="radio" name="copa" value="nao"  id="nao" ${comercial.CopaNao == 'nao' ? 'checked' : ''}>
                                ...
                                <div class="small-12 medium-4 large-4 columns" >
                                    ...
                                    <div class="quantidadeVagasGaragemcomercial-field">
                                ...
                                <div class="small-12 medium-4 large-4 columns" >
                                    ...
                                    <div class="situacaoPinturacomercial-field">
                                        <label>Situação Pintura<small>required</small>

                                            <select name="situacaopintura"> 


                                                <option name="nova" value="nova"  value="${comercial.situacaoPintura}" id="nova">Nova</option>
                                                <option name="usada" value="usada" value="${comercial.situacaoPintura}" id="usada">Usada</option>
                                                <option name="desgastada" value="desgastada" value="${comercial.situacaoPintura}" id="desgastada">Desgastada</option>

                                                <option name="outro" value="outro" value="${comercial.situacaoPintura}" id="outro">Outros</option>
                        ...
                        <div class="row">
                            <div class="large-9  columns">
                                ...
                                <div class="small-12 medium-4 large-4 columns" >
                                    ...
                                    <div class="tipoPisoComercial-field">
                                        <label>Tipo Piso <small>required</small>

                                            <select name="tipopiso"> 


                                                <option name="ceramica" value="ceramica"  value="${comercial.tipoPiso}" id="ceramica">Cerâmica</option>
                                                <option name="porcelana" value="porcelana" value="${comercial.tipoPiso}" id="porcelana">Porcelana</option>
                                                <option name="granito" value="granito" value="${comercial.tipoPiso}" id="granito">Granito</option>

                                                <option name="outro" value="outro" value="${comercial.tipoPiso}" id="outro">Outros</option>
                                ...
                                <div class="small-12 medium-4 large-4 columns" >
                                    <div class="mobiliaComercial-field">
                                        <label>Tem Movéis ? <small>required</small>
                                            </br>
                                            <input type="radio" name="mobilia" value="sim"   id="sim"  ${comercial.mobiliaSim == 'sim' ? 'checked' : ''} >
                                            <label for="sim">Sim</label>
                                            <input type="radio" name="mobilia" value="nao"  id="nao" ${comercial.mobiliaNao == 'nao' ? 'checked' : ''}>
                                            <label for="nao">Não</label>
                                        </label>
                                    </div> 
                            ...
                            <div class="large-9  columns">
                                ...
                                <div class="small-12 medium-6 large-6 columns" >
                                    ...
                                    <div class="ruaimovel-field">
                                        ...
                                        <small class="error">Digite a Rua</small>
                                    </div>
                                </div>
                                ...
                                <div class="small-12 medium-2 large-2 columns" >	
                                    ...
                                    <div class="ufimovel-field">
                                        ...
                                        <small class="error">Digite a uf</small>
                                    </div>
                                </div>
                            ...
                            <div class="large-9  columns">
                                ...
                                <div class="small-12 medium-4 large-4 columns" >
                                    <div class="areaimovel-field">
                                        ...
                                        <small class="error">Digite a Área m²</small>
                                    </div>
                                ...
                                <div class="small-12 medium-4 large-4 columns" >
                                    <div class="tipoanuncioimovel-field">
                                        <label>Tipo Anúncio ? <small>required</small>
                                            </br>
                                            <input type="radio" name="tipoanuncio" value="locacao" id="sim" ${imovel.locacao == 'locacao' ? 'checked' : ''} >
                                            <label for="locacao">Locação</label>
                                            <input type="radio" name="tipoanuncio" value="venda" id="nao" ${imovel.venda == 'venda' ? 'checked' : ''}>
                            ...
                            <div class="large-9  columns">
                                ...
                                <div class="small-12 medium-4 large-4 columns" >
                                    <div class="descricaoimovel-field">
                                        ...
                                        <small class="error">Digite a descricão</small>
                                    </div>
