        ...
        <div class="inner-wrap">
            ...
            <div class="wrap-fluid" id="paper-bg">
                ...
                <ul class="breadcrumbs">
                   ...
                   <div class="expanded row" style=" max-width: 70% ">
           <div class="row" >
                 ...
                 <h3>&nbsp;&nbsp;&nbsp; Conheça e adquira nossos planos</h3>
         ...
         <div class="small-12 medium-4 large-3 columns">
                                ...
                                <ul class="pricing-table">
                                    <li class="title" style="background:#00BFFF ">
                                    ...
                                    <li class="bullet-item"><b>03 </b> Imóveis</li>
                                    <li class="bullet-item"><b>30 </b> Dias</li>
                                   
                                    <li class="cta-button"><a class="button small radius" style="background:#00BFFF" href="#">Comprar</a>
                                    </li>
                                </ul>
          ...
          <div class="small-12 medium-4 large-3 columns">
                                ...
                                <ul class="pricing-table" class="center">
                                    <li class="title" style="background:#008000 ">
                                        <h6 class="text-white">Special</h6>
                                    </li>
                                    <li class="price">
                                        <h2>?? ??</h2>
                                    </li>
                                   
                                    <li class="bullet-item"><b>10 </b> Imóveis</li>
                                    <li class="bullet-item"><b>30</b>  Dias</li>
                                    
                                    <li class="cta-button"><a class="button small radius" style="background:#008000" href="#">Comprar</a>
                                    </li>
                                </ul>
          ...
          <div class="small-12 medium-4 large-3 columns">
                                ...
                                <ul class="pricing-table" class="center">
                                    <li class="title" style="background:#DAA520">
                                    ...
                                    <li class="bullet-item">Quantidade de imóveis<b> Ilimitada</b></li>
                                    <li class="bullet-item"><b>30 </b> Dias</li>
                                    
                                    <li class="cta-button"><a class="button small radius" style="background:#DAA520" href="#">Comprar</a>
                                    </li>
                                </ul>
               ...
               <div class="small-12 medium-3 large-3 columns">
                ...
                <footer>
                    <div id="footer">Todos os Direitos Reservados 2016 <a href="#">Tem </a> Lar</div>
