        ...
        <div class="small-12 medium-12 large-12 columns " > 
            ...
            <ul class="breadcrumbs">
                <li><a href="index.jsp">Página Inicial</a></li>
                         <li class="unavailable"><a href="#">Imóveis a Alugar</a></li>
                       <li><a href="lotealugar.jsp">Lotes</a></li>
                          <li class="unavailable"><a href="#">Detalhes Lote</a></li>
            </ul>
        </div>
           </div>
</div>
...
<div class="small-12 medium-6 large-6 columns" > 
    ...
    <h2 style="color:#FFA500 " class="text-center"><b>ALUGA - SE</b></h2>  
    <h3 style="color:#FFA500 " class="text-center"><b>LOTE</b></h3>  
    <h6 class="text-center" ${lote.endImovel} > Rua Rio de Janeito </h6>
    <h6  class="text-center" ${lote.bairroImovel}>Bairro Imovel    </h6>
    <h6 class="text-center"   ${lote.cidadeImovel}>  Cidade Imovel  </h6>
        ...
        <div class="small-12 medium-6 large-6 columns " > 
           ...
           <h6  ${lote.valorImovel} class="text-center"><b>R$ &nbsp 300,00   </h6></h6>
             ...
             <fieldset>
               <div class="row">
                    ...
                    <div class="small-12 medium-4 large-4  columns " > 
                        <h5 ${lote.tipoMuro} class="text-center"><strong > Tijolos</strong></h5>
                        <h5 class="text-center"><font color = "#A9A9A9"> Tipo Muro </font></h5>
                    </div>
                    <div class="small-12 medium-4 large-4   columns " > 
                        <h5  ${lote.aterrado} class="text-center"><strong> Sim</strong></h5>
                        <h5 class="text-center"><font color = "#A9A9A9">É Aterrado ?</font></h5>
                    </div>
                    <div class="small-12 medium-4 large-4   columns " > 
                        <h5 ${lote.metragemImovel} class="text-center"><strong> 10 X 20</strong></h5>
                        <h5 class="text-center"><font color = "#A9A9A9">Metragem</font></h5>
                    </div>
         ...
         <div class="row">
                <fieldset>	
                    <div class="small-12 medium-12 large-12  columns " >
                        ...
                        <p  class="text-justify" ${lote.descricaoImovel}  >
