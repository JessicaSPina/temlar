        ...
        <div class="small-12 medium-12 large-12 columns " > 
            ...
            <ul class="breadcrumbs">
                ...
                <li class="unavailable"><a href="#">Imóveis Venda</a></li>
                        <li><a href="apartamentovenda.jsp"> Apartamentos a Venda</a></li>
                        <li class="unavailable"><a href="detalhesapartamentovenda.jsp">Detalhes Apartamento Venda</a></li>
           ...
           <div class="expanded row" style=" max-width: 90% ">
             <fieldset>
               <div class="row">
                    ...
                    <div class="small-6 medium-2 large-2   columns " > 
                        <h5 ${casa.numSuites} class="text-center"><strong > 2</strong></h5>
