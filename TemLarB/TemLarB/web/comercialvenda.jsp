        ...
        <div class="small-12 medium-12 large-12 columns " > 
            ...
            <ul class="breadcrumbs">
                <li><a href="index.jsp">Página Inicial</a></li>
                        ...
                        <li class="unavailable"><a href="comercialvenda.jsp">Comercial</a></li>
...
<div class="expanded row" style=" max-width: 95% ">
           <div class="row" >
    <h4 class="text-center" style=" color:orange;" >Comerciais para Venda</h4>
  ...
  <!--c:forEach var="comercial" items="${comerciais}">-->
                    <ul class="pricing-table">
                     ...
                     <li class="bullet-item" ${comercial.mobilia}   ></li>
                        ...
                        <li class="cta-button"><a class="button" href="detalhescomercialvenda.jsp">Confira</a></li>
                    </ul>
