        ...
        <div class="small-12 medium-12 large-12 columns " > 
            ...
            <ul class="breadcrumbs">
                <li><a href="index.jsp">Página Inicial</a></li>
                        ...
                        <li class="unavailable"><a href="comerciallugar.jsp">Comercial</a></li>
...
<div class="expanded row" style=" max-width: 95% ">
           <div class="row" >
    <h4 class="text-center" style=" color:orange;" >Comerciais para Alugar</h4>
...
<div class="small-12 medium-3 large-3 columns " > 
  ...
  <!--c:forEach var="comercial" items="${comerciais}">-->
                    <ul class="pricing-table">
                        ...
                        <img src="#"   />
                        <li class="price" ${comercial.valorImovel} ></li>
                        <li class="description" ${comercial.numSalas} ><b></b></li>
                     <li class="bullet-item" ${comercial.mobilia}   ></li>

                        <li class="bullet-item" ${comercial.areaImovel} ></li>
                        <li class="cta-button"><a class="button" href="detalhescomercialalugar.jsp">Confira</a></li>
                    </ul>
