        ...
        <div class="small-12 medium-12 large-12 columns " > 
            ...
            <ul class="breadcrumbs">
                ...
                <li class="unavailable"><a href="#">Imóveis a Alugar</a></li>
                        <li><a href="comercialalugar.jsp"> Comercial a Alugar</a></li>
                        <li class="unavailable"><a href="detalhescomercialalugar.jsp">Detalhes Comercial</a></li>
...
<div class="small-12 medium-6 large-6 columns" > 
    ...
    <h2 style="color:#FFA500 " class="text-center"><b>ALUGA - SE</b></h2>  
     <h3 style="color:#FFA500 " class="text-center"><b>COMERCIAL</b></h3>  
             ...
             <fieldset>
               <div class="row">
                    ...
                    <div class="small-6 medium-2 large-2  columns " > 
                        <h5 ${comercial.numSalas} class="text-center"><strong > 6</strong></h5>
                        <h5 class="text-center"><font color = "#A9A9A9"> Salas </font></h5>
                    </div>
                    <div class="small-6 medium-2 large-2   columns " > 
                        <h5  ${comercial.mobilia} class="text-center"><strong> Sim</strong></h5>
                        <h5 class="text-center"><font color = "#A9A9A9"> Tem Mobilia?</font></h5>
                    </div>
                    <div class="small-6 medium-2 large-2   columns " > 
                        <h5 ${comercial.copa} class="text-center"><strong > Sim</strong></h5>
                        <h5 class="text-center"><font color = "#A9A9A9"> Tem Copa ?</font></h5>
                    </div>
                    <div class="small-6 medium-2 large-2   columns " > 
                        <h5  ${comercial.numBanheiro} class="text-center"><strong>2</strong></h5>
                        <h5 class="text-center"><font color = "#A9A9A9"> Banheiro</font></h5>
                    </div>
                    <div class="small-6 medium-2 large-2   columns " > 
                        <h5 ${comercial.tipoPiso} class="text-center"><strong> Cerâmica</strong></h5>
                        <h5 class="text-center"><font color = "#A9A9A9"> Tipo Piso</font></h5>
                    </div>
                    <div class="small-6 medium-2 large-2   columns " > 
