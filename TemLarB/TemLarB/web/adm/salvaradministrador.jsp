    ...
    <div class="off-canvas-wrap" data-offcanvas>
        ...
        <div class="row">
                                    ...
                                    <div class="large-9 columns">
                                        ...
                                        <h2> ${sucesso}</h2>
                                        <form data-abide name="salvar" action="<%=request.getContextPath()%>/SalvarAdministrador" method="POST">
                                            <h5> Cadastro de Administrador</h5> 
                                            <div class="id-field">
                                              
                                            <input type="hidden" name="idadministrador" value="${administrador.idAdm}" readonly="readonly" /></br></br>
                                            ...
                                            <div class="name-field">
                                                ...
                                                <label>Nome <small>required</small>
                                                    <input type="text" name="nomeadministrador" value="${administrador.nomeAdm}" required pattern="[a-zA-Z]+"/>
                                                </label>
                                                <small class="error">Digite o Nome</small>
                                            </div>
                                           <div class="cpf-field">
                                                <label>CPF <small>required</small>
                                                    <input type="text" name="cpfadministrador" value="${administrador.cpfAdm}" required pattern=""/>
                                                </label>
                                            ...
                                            <div class="email-field">
                                                <label>Email <small>required</small>
                                                    <input type="text" name="emailadministrador" value="${administrador.emailAdm}" required pattern="^([\w\-]+\.)*[\w\- ]+@([\w\- ]+\.)+([\w\-]{2,3})$"/>
                                                </label>
                                            ...
                                            <div class="login-field">
                                                <label>Login <small>required</small>
                                                    <input type="text" name="loginadministrador" value="${administrador.loginAdm}" required/>
                                                </label>
                                            ...
                                            <div class="password-field">
                                                <label>Senha <small>required</small>
                                                    <input type="password"  name="senhaadministrador" value="${administrador.senhaAdm}"  required pattern="[a-zA-Z]+"/>
                                                </label>
                                                <small class="error">Digite a senha</small>
                                            </div>
                                            <!--<div class="password-confirmation-field">
                                                <label>Confirme sua Senha <small>required</small>
                                                    <input type="password" required pattern="[a-zA-Z]+"  value="" data-equalto="password">
                                                </label>
                                                <small class="error">Digite a senha</small>
                                            </div>-->
                                            <button type="submit" class="tiny" value="Salvar" name="cadastrar">Entrar</button>
                                        </form>
