                                    ...
                                    <tbody>
                                        <c:forEach var="plano" items="${planos}">
                                            <tr>
                                                ...
                                                <td>${plano.periodoPlano}</td>
                                                <td>${plano.valorPlano}</td>
                                                <td>${plano.regrasPlano}</td>
                                                <td>${plano.quantidadeFotosPlano}</td>
                                                 <td>${plano.quantidadeImoveisPlano}</td>
                                                <td><a href="ExcluirPlano?idplano=${plano.idPlano}">Excluir</a></td>
                                                <td><a href="CarregarPlano?idplano=${plano.idPlano}">Alterar</a></td>
