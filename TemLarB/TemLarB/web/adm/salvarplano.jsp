            ...
            <div class="wrap-fluid" id="paper-bg">
                ...
                <!-- end of breadcrumbs -->
                                    ...
                                    <div class="large-9 columns">
                                         <h2> ${sucesso}</h2>
                                        <form data-abide name="salvar" action="<%=request.getContextPath()%>/SalvarPlano" method="POST">
                                            <h5>Cadastro de Plano</h5>
                                            <div class="id-field">
                                              
                                            <input type="hidden" name="idplano" value="${plano.idPlano}" readonly="readonly" /></br></br>
                                                 
                                            </div>
                                            <div class="name-field">
                                                <label>Nome <small>required</small>
                                                    <input type="text" name="nomeplano" value="${plano.nomePlano}" required pattern="[a-zA-Z]+">
                                                </label>
                                                <small class="error">Digite o Nome do Plano</small>
                                            </div>
                                           <div class="periodo-field">
                                                <label>Período<small>required</small>
                                                    <input type="text"  value="${plano.periodoPlano}" name="periodoplano" required >
                                                </label>
                                                <small class="error">Digite o período</small>
                                            </div>
                                            
                                            <div class="valor-field">
                                                <label>Valor <small>required</small>
                                                    <input type="number" value="${plano.valorPlano}" name="valorplano" required>
                                                </label>
                                                <small class="error">Digite o valor</small>
                                            </div>
                                            
                                            <div class="regras-field">
                                                <label>Regras <small>required</small>
                                                    <input type="text" value="${plano.regrasPlano}" name="regrasplano" required>
                                                </label>
                                                <small class="error">Digite a regra</small>
                                            </div>
                                            
                                             <div class="quantidadeFotos-field">
                                                <label>Quantidade de Fotos <small>required</small>
                                                    <input type="number" value="${plano.quantidadeFotosPlano}" name="quantidadefotosplano" required>
                                                </label>
                                                <small class="error">Digite o número de fotos</small>
                                            </div>
                                            
                                            
                                             <div class="quantidadeImoveis-field">
                                                <label>Quantidade de Imóveis<small>required</small>
                                                    <input type="number" value="${plano.quantidadeImoveisPlano}" name="quantidadeimoveisplano" required>
                                                </label>
                                                <small class="error">Digite o número de imóveis</small>
                                            </div>
