                ...
                <!-- end of breadcrumbs -->
                 ...
                 <div class="row">
                                  ...
                                  <div class="large-9 columns">
                                        ...
                                        <h2> ${sucesso}</h2>
                                        <form data-abide name="salvar" action="<%=request.getContextPath()%>/SalvarCidade" method="POST">
                                            <h5> Cadastro de Cidade</h5>
                                            <div class="id-field">
                                              
                                            <input type="hidden" name="idcidade" value="${cidade.idCidade}" readonly="readonly" /></br></br>
                                            ...
                                            <div class="name-field">
                                                ...
                                                <label>Nome <small>required</small>
                                                    <input type="text" name="nomecidade" value="${cidade.nomeCidade}" required pattern="[a-zA-Z]+">
                                                </label>
                                                <small class="error">Digite o Nome</small>
                                            </div>
                                        
                                            <div class="iduf-field">
                                                <label>Sigla UF <small>required</small>
                                                      
            <select name="iduf"> 
                <c:forEach var="uf" items="${ufs}">
                 
                        <option value="${uf.idUf}"
                            <c:if test="${cidade.uf.idUf == uf.idUf}">
                                selected</c:if>>${uf.nomeUf}</option>
