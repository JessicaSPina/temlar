    ...
    <div class="off-canvas-wrap" data-offcanvas>
        ...
        <div class="inner-wrap">
            ...
            <div class="wrap-fluid" id="paper-bg">
                ...
                <div class="top-bar-nest">
                    <nav class="top-bar" data-topbar role="navigation" data-options="is_hover: false">
                        ...
                        <section class="top-bar-section ">
                            ...
                            <ul class="right">
                                <li class=" has-dropdown bg-white">
                                    <a class="bg-white" href="#"><img alt="" class="admin-pic img-circle" src="#"><span class="admin-pic-text text-gray"><c:out value='${sessionScope.nomeAdm}'/>Administrador  </span>
                                    </a>
                ...
                <footer>
                    <div id="footer">Copyright 2015 <a href="#">Themesmile</a> Made with hand</div>
