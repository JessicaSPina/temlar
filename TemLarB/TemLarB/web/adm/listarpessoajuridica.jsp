                                    ...
                                    <li>
                                        ...
                                        <ul>
                                            ...
                                            <li>
                                                ...
                                                <a href="${pageContext.request.contextPath}/adm/listarpessoajuridica.jsp" title="ListarPlano">Listar</a>
                                            </li>
                                        </ul>
                                    </li>
                        ...
                        <div class="box">
                            ...
                            <div class="box-body " style="display: block;">
                                ...
                                <table id="example" class="display" style="width:100%">
                                    ...
                                    <tbody>
                                        <c:forEach var="juridica" items="${juridicas}">
                                            <tr>
                                                <td>${juridica.nomePessoa}</td>
                                                <td>${juridica.cnpjJuridica}</td>
                                                <td>${juridica.ieJuridica}</td>
                                                <td>${juridica.imJuridica}</td>

                                                <td><a href="ExcluirPessoaJuridica?idpessoa=${juridica.idPessoa}">Excluir</a></td>
                                                <td><a href="CarregarPessoaJuridica?idpessoa=${juridica.idPessoa}">Alterar</a></td>
